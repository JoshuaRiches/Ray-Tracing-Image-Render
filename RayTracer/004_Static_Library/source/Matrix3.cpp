...
const Matrix3& Matrix3::operator-=(const Matrix3& a_m3)
{
	m_11 -= a_m3.m_11; m_12 -= a_m3.m_12; m_23 -= a_m3.m_23;
	m_21 -= a_m3.m_21; m_22 -= a_m3.m_22; m_23 -= a_m3.m_23;
	m_31 -= a_m3.m_31; m_32 -= a_m3.m_32; m_33 -= a_m3.m_33;
	return *this;
}
...
void Matrix3::Scale(const Vector3& a_v3)
{
	...
	m_21 = 0.0f; m_22 = a_v3.y; m_33 = 0.0f;
...
{
	m_11 = 1.0f;	m_12 = 0.0f;	m_13 = 0.f;
	m_21 = 0.0f;	m_22 = 1.0f;	m_23 = 0.f;
	m_31 = 0.0f;	m_32 = 0.0f;	m_33 = 1.f;
}
//\-----------------------------------------------------------------------------
// Determinant
//\-----------------------------------------------------------------------------
...
bool Matrix3::Inverse()
{
	...
	// If the determinant is zero this matrix is singular and cannot be inverted
	if (fDet != 0.0f)
	{
